  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed bottom-[calc(env(safe-area-inset-bottom)+5.75rem)] right-[calc(env(safe-area-inset-right)+1.75rem)] z-40 flex h-11 w-11 items-center justify-center rounded-full bg-surface-2 text-primary-hover border border-accent/30 shadow-[0_4px_14px_rgba(0,0,0,0.25)] transition-all duration-300 hover:bg-surface hover:scale-110 ${
          showTop
