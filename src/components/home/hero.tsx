      ...
      <div className="max-w-7xl mx-auto px-4 relative">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="relative mt-12 lg:mt-0">
            <div className="relative rounded-[2rem] overflow-hidden shadow-2xl shadow-primary/20 border border-border-strong bg-surface/50 mx-auto max-w-md lg:max-w-none">
              <Image
            ...
            <div className="absolute -bottom-5 left-1/2 -translate-x-1/2 lg:left-6 lg:translate-x-0 bg-foreground text-background px-5 py-3 rounded-2xl shadow-xl border border-border flex items-center gap-3 w-max">
