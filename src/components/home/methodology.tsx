...
export function Methodology() {
  return (
    <section className="py-16 md:py-32 bg-[#0c1220] text-white relative overflow-hidden border-y border-[rgba(245,236,217,0.08)]">
      <div className="absolute top-0 right-0 w-72 h-72 md:w-96 md:h-96 bg-[#e8873a]/10 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2 pointer-events-none" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <Reveal>
            <div>
              ...
              <h2 className="text-3xl sm:text-4xl md:text-6xl font-black uppercase tracking-tighter leading-none mb-8 md:mb-10 font-display">
                Strategy First. <br className="hidden sm:block" />
                <span className="text-gradient">ROI Guaranteed.</span>
              </h2>
              <div className="space-y-8">
                {pillars.map((p) => (
                  <div key={p.title} className="flex gap-4 md:gap-6 min-w-0">
                    ...
                    <div className="min-w-0">
                      <h4 className="text-lg font-black uppercase tracking-tight mb-2 font-display break-words">
                        {p.title}
                      </h4>
                      <p className="text-[#9aa3b8] text-sm leading-relaxed break-words">
                        {p.desc}
                      </p>
                    </div>
                  </div>
