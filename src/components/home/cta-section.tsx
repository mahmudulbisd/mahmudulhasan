  ...
  return (
    <section id="contact" className="py-32 bg-[#0c1220]">
      <div className="max-w-6xl mx-auto px-4">
        <Reveal>
          <div className="bg-gradient-to-br from-[#b85f1e] via-[#8a4a1f] to-[#1f4d4b] rounded-[3.5rem] p-8 md:p-12 lg:p-16 relative overflow-hidden shadow-[0_40px_100px_-20px_rgba(232,135,58,0.35)] border border-[rgba(245,236,217,0.1)]">
            ...
            <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
              <div className="text-center lg:text-left">
                ...
                <h2 className="text-4xl md:text-5xl font-black text-white uppercase tracking-tighter mb-8 leading-tight font-display">
              ...
              <div className="w-full bg-[#0a0e1a]/70 backdrop-blur-sm border border-white/10 rounded-[2rem] p-6 sm:p-8 shadow-2xl">
