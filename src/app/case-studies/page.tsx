                  ...
                  <Reveal key={cs.slug} delay={i * 80}>
                    ...
                    >
                      <div className="relative aspect-video w-full overflow-hidden">
                        {cs.image ? (
                          ...
                          <div className="w-full h-full bg-gradient-to-br from-[rgba(99,102,241,0.2)] to-[rgba(56,189,248,0.15)] flex items-center justify-center">
                            <TrendingUp className="w-12 h-12 text-[#38bdf8]/40" />
                          </div>
                        )}
                      ...
                      <div className="p-6 md:p-8 flex flex-col flex-1">
                        ...
                        <h2 className="text-xl font-bold text-[#eef2f9] mb-6 break-words">
                          {cs.title}
                        </h2>
                        <div className="space-y-4 flex-1 min-w-0">
                          ...
                          {cs.result && (
                            <div>
                              ...
                              <p className="text-[#38bdf8] text-base font-bold break-words">
                                {cs.result}
                              </p>
                            </div>
                          )}
