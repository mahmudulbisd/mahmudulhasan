          ...
          <div className="max-w-7xl mx-auto px-6">
            <Reveal>
              <div className="text-center mb-16">
                ...
                <h1 className="text-4xl md:text-6xl font-black mb-6 text-[#eef2f9] font-display">
                  Comprehensive{" "}
            ...
            <div className="space-y-12">
              {services.map((service, i) => (
                <Reveal key={service.slug} delay={i * 80}>
                  <div className="bg-[rgba(21,30,54,0.5)] border border-[rgba(238,242,249,0.08)] rounded-3xl p-8 md:p-12 shadow-sm hover:shadow-md hover:border-[rgba(99,102,241,0.4)] transition-all">
                    <div className="flex flex-col md:flex-row gap-8 items-start">
                      <div className="w-16 h-16 bg-[rgba(99,102,241,0.12)] rounded-2xl flex items-center justify-center shrink-0 border border-[rgba(99,102,241,0.3)]">
                        <service.icon className="w-8 h-8 text-[#6366f1]" />
                      </div>
                      <div className="flex-1">
                        <h2 className="text-2xl md:text-3xl font-bold mb-4 text-[#eef2f9] font-display">
                          {service.title}
                        </h2>
                      ...
                      <div className="mt-6 md:mt-0 md:ml-8 shrink-0 w-full md:w-auto">
                        <a
                          ...
                          className="inline-flex items-center justify-center w-full md:w-auto h-12 px-8 rounded-full bg-gradient-to-r from-[#6366f1] to-[#4f46e5] text-white font-bold hover:from-[#818cf8] hover:to-[#6366f1] transition-colors gap-2"
                        >
